...
import activityComponent from '@/components/takeout/activity.vue'
import deliveryComponent from '@/components/takeout/delivery.vue'
import foodsComponent from '@/components/takeout/foods.vue'
